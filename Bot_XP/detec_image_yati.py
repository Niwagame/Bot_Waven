...
if None not in game_window_coordinates:
    ...
    # start_position[0], {start_position[1] - Largeur: {width}, Hauteur: {height}
    show_region((782, 511, 100, 106), game_window_coordinates=game_window_coordinates)
    ...
    #detected = detection_images(images_to_check, (376, 328, 800, 410), game_window_coordinates)
